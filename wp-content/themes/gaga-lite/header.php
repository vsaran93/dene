...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?>>
        <div id="page" class="hfeed site">
            <a class="skip-link screen-reader-text" href="#content"><?php _e('Skip to content', 'gaga-lite'); ?></a>
                            ...
                            <div id="menu">
                                ...
                                <?php $primery_menu_enable = get_theme_mod('gaga-lite-custom_menu_enable');
                                    if($primery_menu_enable != '1'){?>
                                        ...
                                        <ul class="nav plx-nav clearfix"><?php
                                            $home = get_theme_mod('gaga-lite-home_menu_text');
                                            if ($home == '') {
                                                $home = __('Home','gaga-lite');
                                            }?>                                                                     
                                            <li><a class="current" href="<?php echo esc_url(home_url('/')); ?>#home_slider"><?php echo esc_attr($home); ?></a></li><?php
            ...
            <?php }?>
            <div id="page" class="hfeed site">
                <a class="skip-link screen-reader-text" href="#content"><?php esc_html_e('Skip to content', 'gaga-lite'); ?></a>
            </div>
            <?php if (is_home() || is_front_page()) : ?>
                <section id="home_slider">
                    <div class="slider_area"><?php
                        ...
                        if (get_theme_mod('gaga-lite-slider_enable_disable') == 1) {
                            ...
                            if ($slider_query->have_posts() && $slider_iamges) :?>
                                ...
                                <?php
                                $slider_layout = get_theme_mod('gaga_lite_full_slider');
                                    if($slider_layout){ ?>
                                                <div id="slider_full_window">
                                                    <?php while ($slider_query->have_posts()) : 
                                                            $slider_query->the_post();
                                                            $img = wp_get_attachment_image_src(get_post_thumbnail_id(), 'slider_image');
                                                            $img_src = $img[0];?>                     
                                                        <div class="slider_content_loop">
                                                            <img src="<?php echo esc_url($img_src); ?>" title="<?php the_title_attribute(); ?>" alt="<?php the_title_attribute(); ?>" />
                                                                <div class="slider_capation">
                                                                    <div class="ak-container wow fadeInUp">
                                                                        ...
                                                                        <div class="slider_content highlite"> <?php echo wp_kses_post($content); ?> </div>
                                                                    </div>
                                                                </div>
                                                        </div>
                                                    <?php endwhile; ?>
                                                </div>
                                                <a href="" id="arrow_left"><img src="<?php echo get_template_directory_uri(); ?>/images/team_left.png" alt="Slide Left" /></a>
                                                <a href="" id="arrow_right"><img src="<?php echo get_template_directory_uri(); ?>/images/team_right.png" alt="Slide Right" /></a>
                                    <?php } 
                                    else{?>
                                    <ul class="bxslider clearfix">
                                        ...
                                        if ($link == '') {
                                            ...
                                            <span  class="next-page" ><a href="<?php echo esc_url(home_url()) . '/' . $link; ?>"><i class="fa fa-angle-double-down"></i></a></span><?php
                                        }?> 
                                </div><?php
                            endif;
                        }?>
